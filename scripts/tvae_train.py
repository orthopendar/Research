...
# --------------------------------------------------------------------------------
# 0. Update sys.path to include the parent directory of the package
# --------------------------------------------------------------------------------
...
# 1. Define File Paths
# --------------------------------------------------------------------------------
DATASET_PATH = r"C:\Users\ortho\OneDrive\Desktop\TVAE\my_project\data\final_dataset.csv"
OUTPUT_DIR = r"C:\Users\ortho\OneDrive\Desktop\TVAE\my_project\output"
...
tvae.save(filepath=MODEL_PATH)
print(f"🚀 TVAE model saved successfully to {MODEL_PATH}!")

# --------------------------------------------------------------------------------
# 8. Generate and Save Synthetic Data
# --------------------------------------------------------------------------------
synthetic_data = tvae.sample(num_rows=len(df))
